      ...
      if (typeof com.appsflyer.AppsFlyerLib !== "undefined") {
            ...
            _appsFlyerConversionListener =
              new com.appsflyer.AppsFlyerConversionListener(<any>{
                ...
                onConversionDataSuccess(
                  conversionData: java.util.Map<string, string>
                ): void {
                ...
                onAppOpenAttribution(
                  onAppOpenAttributionData: java.util.Map<any, any>
                ): void {
        ...
        if (args.onDeepLinking) {
          try {
            appsFlyerLibInstance.subscribeForDeepLink(
              new com.appsflyer.deeplink.DeepLinkListener(<any>{
        ...
        appsFlyerLibInstance.init(
          ...
          Application.android.context ||
            (<any>com).tns.NativeScriptApplication.getInstance()
        );
      ...
      if (args.onSuccess || args.onError) {
        try {
          _appsFlyerRequestListener =
            new com.appsflyer.attribution.AppsFlyerRequestListener(<any>{
    ...
    try {
      ...
      if (args.onSuccess && args.onError) {
        const listener: com.appsflyer.CreateOneLinkHttpTask.ResponseListener =
          new com.appsflyer.CreateOneLinkHttpTask.ResponseListener(<any>{
            _successCallback: args.onSuccess,
            _failureCallback: args.onError,
            onResponse(): void {
              if (!this._successCallback) {
...
const setSharingFilter = function (partners: Array<string>) {
  return new Promise(function (resolve, reject) {
    try {
      const appsFlyerLibInstance = com.appsflyer.AppsFlyerLib.getInstance();
